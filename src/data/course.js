...
export const cards = {
  ...
  magician: {
    ...
    symbols: [
      { part: '指天指地的手势', meaning: '连接天与地，把意念落实到现实', at: { x: 30, y: 14 } },
      { part: '头顶的无限符号 ∞', meaning: '无穷的潜能与能量', at: { x: 43, y: 31 } },
      { part: '桌上的四件法器', meaning: '风火水土四元素，资源齐备', at: { x: 26, y: 57 } },
      { part: '红袍与白衣', meaning: '经验与纯粹意图的结合', at: { x: 60, y: 44 } },
      { part: '衔尾蛇腰带', meaning: '永恒与自我更新', at: { x: 45, y: 66 } },
      { part: '头顶的玫瑰与百合', meaning: '欲望与纯洁并存', at: { x: 50, y: 88 } },
    ],
    template: {
      prompt: '把魔术师翻译成一段解读',
  ...
  priestess: {
    ...
    symbols: [
      { part: '黑白双柱', meaning: '二元对立，有形世界的门槛', at: { x: 11, y: 48 } },
      { part: '身后的帘幕', meaning: '遮蔽的潜意识与未知秘密', at: { x: 64, y: 22 } },
      { part: '怀中的卷轴', meaning: '隐秘的更高知识', at: { x: 44, y: 58 } },
      { part: '头顶的月冠', meaning: '直觉与月亮的阴性能量', at: { x: 48, y: 25 } },
      { part: '脚边的弦月', meaning: '周期与潜意识的潮汐', at: { x: 52, y: 83 } },
    ],
    template: {
      prompt: '把女祭司翻译成一段解读',
  ...
  empress: {
    ...
    symbols: [
      { part: '茂盛的麦田', meaning: '丰收与物质的丰盛', at: { x: 32, y: 90 } },
      { part: '金星 ♀ 盾牌', meaning: '爱、美与女性能量', at: { x: 24, y: 74 } },
      { part: '十二星之冠', meaning: '与自然周期、黄道的连结', at: { x: 44, y: 16 } },
      { part: '身后的流水森林', meaning: '情感的滋养与生命力', at: { x: 84, y: 46 } },
      { part: '柔软的靠枕长裙', meaning: '感官的享受与舒适', at: { x: 55, y: 52 } },
    ],
    template: {
      prompt: '把皇后翻译成一段解读',
